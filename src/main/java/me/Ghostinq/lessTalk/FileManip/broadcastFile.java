...
public class broadcastFile {
    ...
    public static void Save() {
        file = new File(LessTalk.getInstance().getDataFolder(), "ChatMessages/Broadcast.yml");
    ...
    public static void Load() throws IOException, InvalidConfigurationException {
        ...
        if (!file.exists()) LessTalk.getInstance().saveResource("ChatMessages/Broadcast.yml", false);
        config.load(file);
    }
